...
export default function TermsPage (props) {
  ...
  return (
    <div>
      <SeoHead
        title="South Florida Ultimate Terms & Conditions"
        description="Read the terms, participation waiver, and event conditions for South Florida Ultimate leagues and events."
        path="/terms"
      />
